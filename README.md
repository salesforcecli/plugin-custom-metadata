...
custommetadata/0.0.0 darwin-x64 node-v10.15.0
...
OPTIONS
  ...
  -i, --ignoreunsupported=ignoreunsupported  Flag to ignore non-supported field types (these fields will not be
                                             created). Default is to create text fields and convert source to text.
